...
import com.chroniccare.models.Wishlist;
...
public class WishlistController {
    ...
    @FXML
    private TableColumn<WishlistItem, String> nomCol;
    @FXML
    private TableColumn<WishlistItem, Double> prixCol;
    @FXML
    private TableColumn<WishlistItem, Integer> stockCol;
    @FXML
    private TableColumn<WishlistItem, Void> actionsCol;
    @FXML
    ...
    public void initialize() {
        ...
        actionsCol.setCellFactory(col -> new TableCell<>() {
...

            {
                ...
                btnRetirer.setStyle(
                        "-fx-background-color: #ef4444; -fx-text-fill: white; -fx-cursor: hand; -fx-background-radius: 5;");
