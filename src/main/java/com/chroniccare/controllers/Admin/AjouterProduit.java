...
public class AjouterProduit {
    ...
    public void initialize() {
        // Catégories en liste déroulante : on récupère celles existantes + quelques
        // valeurs par défaut
        try {
            ...
            categorieCombo
                    .setItems(FXCollections.observableArrayList("Cosmétiques", "Compléments", "Vitamines", "Autre"));
