...
public class NutritionRdvController {
    ...
    @FXML public void goToHome() { FxNavigation.navigateNutri(getClass(), sidebarAvatar, "home"); }
    @FXML public void goToProfile() { FxNavigation.navigateNutri(getClass(), sidebarAvatar, "profile"); }
    @FXML public void goToRdv() { FxNavigation.navigateNutri(getClass(), sidebarAvatar, "rdv"); }
    @FXML public void goToNutritionHomeSuivi() { FxNavigation.navigateNutri(getClass(), sidebarAvatar, "suivi"); }
    @FXML public void showEtatModule() { FxNavigation.navigateNutri(getClass(), sidebarAvatar, "etat"); }
    @FXML public void showActiviteModule() { FxNavigation.navigateNutri(getClass(), sidebarAvatar, "activite"); }
