...
public class PatientEventDetailsController {
    ...
    @FXML public void goToEvents() { FxNavigation.navigatePatient(getClass(), exercisesTable, "events"); }
    @FXML public void goToPatientEvents() { FxNavigation.navigatePatient(getClass(), exercisesTable, "events"); }
    @FXML public void goToMyRegistrations() { FxNavigation.navigatePatient(getClass(), exercisesTable, "registrations"); }
    @FXML public void goToPatientRegistrations() { FxNavigation.navigatePatient(getClass(), exercisesTable, "registrations"); }
    @FXML public void goToPatientBookRdv() { FxNavigation.navigatePatient(getClass(), exercisesTable, "rdv"); }
    @FXML public void goToPatientConsultations() { FxNavigation.navigatePatient(getClass(), exercisesTable, "consultations"); }
    @FXML public void goToHomeEtat() { FxNavigation.navigatePatient(getClass(), exercisesTable, "etat"); }
    @FXML public void goToHomeActivite() { FxNavigation.navigatePatient(getClass(), exercisesTable, "activite"); }
    @FXML public void goToHome() { FxNavigation.navigatePatient(getClass(), exercisesTable, "home"); }
    @FXML public void goToProfile() { FxNavigation.navigatePatient(getClass(), exercisesTable, "profile"); }
