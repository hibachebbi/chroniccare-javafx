...
import com.chroniccare.controllers.PatientShellController;
...
public class PatientEventsController {
    ...
    private void openEventDetails(Event event) {
        ...
        PatientShellController shell = PatientShellController.getInstance();
        if (shell != null && shell.isInActiveScene()) {
            try {
                ...
                shell.setPageTitle("Detail evenement");
            } catch (Exception e) {
    ...
    @FXML
    public void goToMyRegistrations() { FxNavigation.navigatePatient(getClass(), eventsTable, "registrations"); }
    @FXML
    public void goToPatientRegistrations() { FxNavigation.navigatePatient(getClass(), eventsTable, "registrations"); }
    @FXML
    public void goToPatientBookRdv() { FxNavigation.navigatePatient(getClass(), eventsTable, "rdv"); }
    @FXML
    public void goToPatientConsultations() { FxNavigation.navigatePatient(getClass(), eventsTable, "consultations"); }
    @FXML
    public void goToPatientEvents() { FxNavigation.navigatePatient(getClass(), eventsTable, "events"); }
    @FXML
    public void goToHomeEtat() { FxNavigation.navigatePatient(getClass(), eventsTable, "etat"); }
    @FXML
    public void goToHomeActivite() { FxNavigation.navigatePatient(getClass(), eventsTable, "activite"); }
    @FXML
    public void goToHome() { FxNavigation.navigatePatient(getClass(), eventsTable, "home"); }
    @FXML
    public void goToProfile() { FxNavigation.navigatePatient(getClass(), eventsTable, "profile"); }
