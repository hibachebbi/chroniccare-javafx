...
public class Etat {
    ...
    public String getRemarquesCliniques() {
        return remarquesCliniques;
    }

    public void setRemarquesCliniques(String remarquesCliniques) {
        this.remarquesCliniques = remarquesCliniques;
    }
    ...
    public String getNiveauHydratation() {
        return niveauHydratation;
    }

    public void setNiveauHydratation(String niveauHydratation) {
        this.niveauHydratation = niveauHydratation;
    }
    ...
    public String toString() {
        return "Etat #" + (id == null ? "N/A" : id) + " - user " + (utilisateurId == null ? "N/A" : utilisateurId);
    }
